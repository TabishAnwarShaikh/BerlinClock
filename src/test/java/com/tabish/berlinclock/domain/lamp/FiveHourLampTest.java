...
/**
 * Unit Tests for the {@link com.tabish.berlinclock.domain.lamp.FiveHourLamp}
 */
...
public class FiveHourLampTest {
    ...
    public static Collection<Object[]> testData() {
        return Arrays.asList(new Object[][]{{"00:00:00", 1, 'O'}, {"00:00:00", 2, 'O'}, {"00:00:00", 3, 'O'}, {"00:00:00", 4, 'O'},
                {"23:59:59", 1, 'R'}, {"23:59:59", 2, 'R'}, {"23:59:59", 3, 'R'}, {"23:59:59", 4, 'R'},
                {"24:00:00", 1, 'R'}, {"24:00:00", 2, 'R'}, {"24:00:00", 3, 'R'}, {"24:00:00", 4, 'R'},
                {"13:17:01", 1, 'R'}, {"13:17:01", 2, 'R'}, {"13:17:01", 3, 'O'}, {"13:17:01", 4, 'O'}
        });
    }

    public FiveHourLampTest(String input, int position, char expected) {
        this.input = input;
    ...
    public void test() {
        ...
        Lamp lamp = new FiveHourLamp(localTime, this.position);
